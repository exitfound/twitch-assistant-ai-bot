...
REQUIRED = {
    ...
    'texts': (
        ...
        'roll_no_free', 'roll_no_free_reward', 'roll_error', 'roll_offline', 'roll_bad_input',
        'rollstat_self', 'rollstat_none', 'rollstat_cursed', 'rollstat_curse_hold',
        'rollstat_shield_left', 'rollstat_perk_shield', 'rollstat_loser', 'rollstat_nobody',
        'roll_perks_both', 'roll_perks_champion', 'roll_perks_loser',
        'roll_perk_shield_on', 'roll_perk_curse_on',
        'reward_extra_title', 'reward_extra_prompt', 'reward_reroll_title', 'reward_reroll_prompt',
        'reward_curse_title', 'reward_curse_prompt', 'reward_shield_title', 'reward_shield_prompt',
        'reward_cleanse_title', 'reward_cleanse_prompt',
        'reward_extra_done', 'reward_extra_cursed', 'reward_reroll_done', 'reward_reroll_first',
        'reward_curse_hit', 'reward_shield_up', 'reward_cleanse_done', 'reward_cleanse_self',
        'reward_refund_free_left', 'reward_refund_extra_pause', 'reward_refund_bad_target',
        'reward_refund_extra_words', 'reward_refund_self',
        'reward_refund_not_rolled', 'reward_refund_shield_holds', 'reward_refund_shield_still_up',
        'reward_refund_already_cursed', 'reward_refund_protected', 'reward_refund_unknown_target',
        'reward_refund_perk_shield', 'reward_refund_offline', 'reward_refund_not_cursed',
        'reward_refund_cleansed',
        'reward_error',
        'ask_usage', 'ask_error', 'ask_no_left',
        'ascii_usage', 'ascii_bad_url', 'ascii_failed', 'ascii_too_big',
        'ascii_blocked', 'ascii_unchecked', 'ascii_no_left',
        'clip_done', 'clip_bad_length', 'clip_usage', 'clip_title', 'clip_offline', 'clip_bad_title', 'clip_rejected',
        'clip_failed', 'clip_no_left',
